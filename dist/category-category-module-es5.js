...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["category-category-module"], {
  ...
  /***/
  function srcAppMainCategoryCategoryListCategoryListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_shared_utility_utils_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/shared/utility/utils.service */
    "./src/app/shared/utility/utils.service.ts");
    /* harmony import */


    var src_app_shared_enums_category_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! src/app/shared/enums/category.enum */
    "./src/app/shared/enums/category.enum.ts");
    /* harmony import */


    var src_app_shared_ng_select_items__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var src_app_shared_core_authentication_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/shared/core/authentication.service */
    "./src/app/shared/core/authentication.service.ts");
    /* harmony import */


    var src_app_shared_core_product_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    var _shared_pt_components_product_card_loading_product_card_loading_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    ...
    var _shared_pt_components_product_card_product_card_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    function CategoryListComponent_ng_template_9_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var item_r144 = ctx.item;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("src", "../../../assets/icons/", item_r144.img, "", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", item_r144.label, "");
      }
    }

    function CategoryListComponent_ng_template_10_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "img", 23);
      ...
      if (rf & 2) {
        var item_r145 = ctx.item;

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate1"]("src", "../../../assets/icons/", item_r145.img, "", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"](" ", item_r145.label, " ");
      }
    }

    function CategoryListComponent_section_19_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("A moment please while we find the products available in ", ctx_r140.category, " category.");
      }
    }

    function CategoryListComponent_section_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function CategoryListComponent_div_24_Template(rf, ctx) {
      if (rf & 1) {
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("product", product_r147)("page", "category-list");
      }
    }

    function CategoryListComponent_button_28_Template(rf, ctx) {
      if (rf & 1) {
        var _r150 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 38);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CategoryListComponent_button_28_Template_button_click_0_listener() {
          ...
          return ctx_r149.noOfProductsToShow = ctx_r149.noOfProductsToShow + ctx_r149.noOfProductsToShow;
        });
    ...
    var CategoryListComponent = /*#__PURE__*/function () {
      function CategoryListComponent(router, route, authenticationService, productService) {
        ...
        this.products = []; // retailerWiseProducts: any;
      ...
      _createClass(CategoryListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function () {
            ...
            _this.category = _this.route.snapshot.paramMap.get("category");

            if (_this.category) {
              _this.getPrdocutsByCategory();
            } else {
        ...
        value: function getPrdocutsByCategory() {
          ...
          this.productService.getProductsByCategory(this.category).subscribe(function (res) {
            // console.log(res);
            _this2.products = _this2.shuffle(res); // this.retailerWiseProducts = this.groupBy(this.products, 'retailerType');
            // console.log(this.groupBy(this.products, 'retailerType'));

            _this2.route.queryParams.pipe().subscribe(function (params) {
              if (params.pr && params.pr !== '') {
                _this2.sortProducts('price', params.pr);

                _this2.selectedSortItem = params.pr;
              } else if (params.av && params.av !== '') {
                _this2.sortProducts('availability', params.av);

                _this2.selectedSortItem = params.av;
              }
            });
          });
        }
        ...
        value: function categorySelectChange(event) {
          var _this3 = this;
          ...
          this.route.queryParams.pipe().subscribe(function (params) {
            _this3.router.navigate(['/category/' + _this3.category], {
        ...
        key: "getAllProducts",
        value: function getAllProducts() {} // Accepts the array and key
              ...
              for (var i = this.products.length - 1; i >= 0; i--) {
                this.products.forEach(function (product, index) {
                  if (product.cost == 0) {
                    ...
                    _this4.products.push(_this4.products.splice(index, 1)[0]);
                  }
                });
              }
            ...
            if (criteria == 'is') {
              ...
              this.products.forEach(function (product, i) {
                if (product.availability.toString() === "In_stock") {
                  _this4.products.splice(i, 1);

                  _this4.products.unshift(product);
                }
              });
            }
          }
        ...
        value: function updateQueryParams(property, criteria) {
          if (property === 'price' && criteria === 'l2h') {} else if (property === 'price' && criteria === 'h2l') {}
    ...
    CategoryListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function CategoryListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CategoryListComponent_Template_ng_select_ngModelChange_8_listener($event) {
            return ctx.category = $event;
          })("change", function CategoryListComponent_Template_ng_select_change_8_listener($event) {
            return ctx.categorySelectChange($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CategoryListComponent_Template_ng_select_ngModelChange_18_listener($event) {
            return ctx.selectedSortItem = $event;
          })("change", function CategoryListComponent_Template_ng_select_change_18_listener($event) {
            return ctx.sortItemChange($event);
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CategoryListComponent, [{
        ...
        return [{
          ...
          type: src_app_shared_core_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"]
        }, {
          type: src_app_shared_core_product_service__WEBPACK_IMPORTED_MODULE_6__["ProductService"]
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function srcAppMainCategoryCategoryRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppMainCategoryCategoryModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    CategoryModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_6__["NgSelectModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"].withConfig({
        warnOnNgModelWithFormControl: 'never'
      }), _category_routing_module__WEBPACK_IMPORTED_MODULE_2__["CategoryRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_7__["BsDropdownModule"].forRoot(), ngx_bootstrap_progressbar__WEBPACK_IMPORTED_MODULE_8__["ProgressbarModule"].forRoot()]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](CategoryModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _ng_select_ng_select__WEBPACK_IMPORTED_MODULE_6__["NgSelectModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _category_routing_module__WEBPACK_IMPORTED_MODULE_2__["CategoryRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_7__["BsDropdownModule"], ngx_bootstrap_progressbar__WEBPACK_IMPORTED_MODULE_8__["ProgressbarModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppSharedUtilityUtilsServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var UtilsService = /*#__PURE__*/function () {
      ...
      _createClass(UtilsService, null, [{
        key: "stringEnumToKeyValue",
        value: function stringEnumToKeyValue(stringEnum) {
          var keyValue = [];
          var keys = Object.keys(stringEnum).filter(function (value, index) {
            return !(index % 2);
          });
        ...
        key: "updateQueryParams",
        value: function updateQueryParams(router, route, queryParams) {
          router.navigate([], {
            relativeTo: route,
            queryParams: queryParams,
            queryParamsHandling: 'merge'
